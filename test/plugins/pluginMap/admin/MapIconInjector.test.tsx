...
vi.mock('@ant-design/icons', async () => {
    ...
    return {
        ...actual,
        EnvironmentOutlined: (props: any) => <span data-testid="map-icon" {...props} />,
        TransactionOutlined: (props: any) => <span data-testid="transaction-icon" {...props} />,
        AppstoreOutlined: (props: any) => <span data-testid="app-icon" {...props} />,
    };
});
...
describe('MapIconInjector', () => {
    it('should render transaction block for G1 extension point', () => {
        ...
        expect(screen.getByText(/Payment Provider Transactions/i)).toBeInTheDocument();
    });
    ...
    it('should handle small and large sizes', () => {
        const { rerender } = render(<MapIconInjector extensionPointId="RA1" size="small" />);
        ...
        rerender(<MapIconInjector extensionPointId="RA1" size="medium" as any />);
        icon = screen.getByTestId('map-icon');
