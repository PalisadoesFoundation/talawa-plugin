...
const mockRequests = [
    createMockRequest({ id: 'req-global', pollNumber: 1, extensionPoint: 'RU2', userId: 'test-user-id' }),
];
...
describe('ExtensionPointsGlobal', () => {
    ...
    it('should render the global extension point title', async () => {
        ...
        expect(screen.getByText('RU2 - User Global Extension Point')).toBeInTheDocument();
