...
Defined in: [plugins/Razorpay/api/graphql/queries.ts:363](https://github.com/PalisadoesFoundation/talawa-plugin/tree/mainplugins/Razorpay/api/graphql/queries.ts#L363)
