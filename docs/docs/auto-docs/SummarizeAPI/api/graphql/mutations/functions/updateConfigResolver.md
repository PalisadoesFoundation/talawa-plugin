...
Defined in: [plugins/SummarizeAPI/api/graphql/mutations.ts:167](https://github.com/PalisadoesFoundation/talawa-plugin/tree/mainplugins/SummarizeAPI/api/graphql/mutations.ts#L167)
