...
Defined in: [plugins/Plugin Map/api/graphql/queries.ts:15](https://github.com/PalisadoesFoundation/talawa-plugin/tree/main/plugins/Plugin Map/api/graphql/queries.ts#L15)
