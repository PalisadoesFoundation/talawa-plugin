...
Defined in: [plugins/Plugin Map/api/database/tables.ts:19](https://github.com/PalisadoesFoundation/talawa-plugin/tree/main/plugins/Plugin Map/api/database/tables.ts#L19)
