...
Defined in: [plugins/pluginMap/api/database/tables.ts:30](https://github.com/PalisadoesFoundation/talawa-plugin/tree/main/plugins/pluginMap/api/database/tables.ts#L30)
