...
This project focuses on ensuring a fully internationalized experience relative to `talawa-admin`. We employ automated checks to enforce translation compliance.
